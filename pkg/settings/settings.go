...
var (
	...
	ImageDefaultStorageClassParameters = NewSetting(ImageDefaultStorageClassParametersSettingName, `{"numberOfReplicas":"3","staleReplicaTimeout":"30","migratable":"true"}`)
)
...
const (
	...
	ImageDefaultStorageClassParametersSettingName = "image-default-storage-class-parameters"
)
